...
Testing Kubernetes is pretty complicated. We will try to make it easy for you, but you might want to start by reading the [Development Guide](https://git.k8s.io/community/blob/master/contributors/devel/development.md).
...
* [SIG Testing](https://git.k8s.io/community/tree/master/contributors/devel/sig-testing) is responsible for maintaining the test framework.
...
* [Learn how to run them in the Development Guide.](https://git.k8s.io/community/blob/master/contributors/devel/development.md#presubmission-verification)
...
* [Read everything there is to know about unit tests in the Testing Guide.](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/testing.md#unit-tests)
...
* [Read Integration Testing in Kubernetes to learn more about this type of test.](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/integration-tests.md)
...
You will not need to run E2E tests for every pull request. [The End-to-End Testing Guide is a great place to learn more.](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/e2e-tests.md)
...
* [SIG Testing documentation](https://git.k8s.io/community/tree/master/contributors/devel/sig-testing)
* [The Development Guide](https://git.k8s.io/community/blob/master/contributors/devel/development.md#presubmission-verification)
* [The Testing Guide](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/testing.md#unit-tests)
* [Integration Testing in Kubernetes](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/integration-tests.md)
* [End-to-End Testing Guide](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/e2e-tests.md)
