...
* [Kubernetes hosts multiple projects on GitHub](https://git.k8s.io/), including Kubernetes itself and the [Kubernetes Community repository](https://git.k8s.io/community).
...
* Official members of the Kubernetes community need their GitHub accounts to [meet certain other requirements](https://git.k8s.io/community/blob/master/community-membership.md).
...
* The process is [outlined in the Community repository](https://git.k8s.io/community/blob/master/CLA.md).
