...
* Issues that affect more than one group need to be [discussed on the kubernetes-dev email list](https://git.k8s.io/community/tree/master/communication#decisions-are-made-here).
* Decisions affecting a single group can be [handled in GitHub](https://git.k8s.io/community/tree/master/github-management).
