...
New features are added through a process that begins with a [Kubernetes Enhancement Proposal](https://git.k8s.io/enhancements/blob/master/keps/README.md).
...
* To learn more, [read the SIG Architecture documentation](https://git.k8s.io/community/blob/master/sig-architecture/README.md).
