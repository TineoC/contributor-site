...
Read more about this method in [Building Kubernetes](https://git.k8s.io/kubernetes/blob/master/build/README.md).
...
To set this method up, [follow the steps from the Development Guide](https://git.k8s.io/community/blob/master/contributors/devel/development.md#building-kubernetes-on-a-local-osshell-environment).
...
But first, we recommend that you [become familiar with the Development Guide](https://git.k8s.io/community/blob/master/contributors/devel/development.md).
