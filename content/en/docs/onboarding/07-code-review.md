...
* The requirements for becoming an approved reviewer differ across SIGs.
    * For an excellent example, [read about SIG-Node approvers and reviewers](https://git.k8s.io/community/blob/master/sig-node/sig-node-contributor-ladder.md#sig-node-reviewers-and-approvers).
...
* Follow the project [coding conventions](https://git.k8s.io/community/blob/master/contributors/guide/coding-conventions.md).
...
The Contributor Guide has [more guidelines and tips for passing reviews](https://git.k8s.io/community/blob/master/contributors/guide/contributing.md#code-review).
