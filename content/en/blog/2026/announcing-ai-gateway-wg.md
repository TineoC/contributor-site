...
The AI Gateway Working Group operates under a clear [charter](https://git.k8s.io/community/blob/master/wg-ai-gateway/charter.md) with the mission to develop proposals for Kubernetes Special Interest Groups (SIGs) and their sub-projects.
...
- Read the working group's [charter](https://git.k8s.io/community/blob/master/wg-ai-gateway/charter.md).
