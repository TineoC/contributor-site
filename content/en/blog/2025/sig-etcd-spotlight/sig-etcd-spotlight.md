...
Instrumentation](https://git.k8s.io/community/tree/master/sig-instrumentation), where I
...
([Kubernetes Enhancement Proposals](https://git.k8s.io/enhancements/blob/master/keps/README.md) 
and PRRs ([Production Readiness Reviews](https://git.k8s.io/community/blob/master/sig-architecture/production-readiness.md),
...
Machinery](https://git.k8s.io/community/blob/master/sig-api-machinery/README.md), 
[SIG Scalability](https://git.k8s.io/community/tree/master/sig-scalability), 
[SIG Testing](https://git.k8s.io/community/tree/master/sig-scalability), 
[SIG Cluster Lifecycle](https://git.k8s.io/community/tree/master/sig-cluster-lifecycle), etc. 

This collaboration helps ensure etcd's development aligns with the needs of the wider Kubernetes
ecosystem. The formation of the [etcd Operator Working Group](https://git.k8s.io/community/blob/master/wg-etcd-operator/README.md) 
...
[SIG etcd meetings](https://git.k8s.io/community/blob/master/sig-etcd/README.md#meetings), 
