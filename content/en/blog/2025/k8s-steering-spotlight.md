...
Testing](https://git.k8s.io/community/blob/master/sig-testing/README.md), and currently a
tech lead of SIG Testing and [SIG K8s Infra](https://git.k8s.io/community/blob/master/sig-k8s-infra/README.md).
...
ContribEx](https://git.k8s.io/community/blob/master/sig-k8s-infra/README.md) (where I am
also a chair), [API
Machinery](https://git.k8s.io/community/blob/master/sig-k8s-infra/README.md),
[Architecture](https://git.k8s.io/community/blob/master/sig-architecture/README.md), and
[SIG Release](https://git.k8s.io/community/blob/master/sig-release/README.md), where I
...
Node](https://git.k8s.io/community/blob/master/sig-node/README.md) and [SIG
Testing](https://git.k8s.io/community/blob/master/sig-testing/README.md). Besides, I
...
**Patrick**: Hello! I’m [Patrick](https://www.linkedin.com/in/patrickohly/). I’ve contributed to Kubernetes since 2018. I started in [SIG Storage](https://git.k8s.io/community/blob/master/sig-storage/README.md) and then got involved in more and more areas. Nowadays, I am a SIG Testing tech lead, logging infrastructure maintainer, organizer of the [Structured Logging](https://git.k8s.io/community/tree/master/wg-structured-logging) and [Device Management](https://git.k8s.io/community/tree/master/wg-device-management) working groups, contributor in [SIG Scheduling](https://git.k8s.io/community/blob/master/sig-scheduling/README.md), and of course member of the Steering Committee. My main focus area currently is [Dynamic Resource Allocation (DRA)](https://kubernetes.io/docs/concepts/scheduling-eviction/dynamic-resource-allocation/), a new API for accelerators.

**Maciej**: Hey, my name is [Maciej](https://www.linkedin.com/in/maciejszulik/) and I've been working on Kubernetes since late 2014 in various areas, including controllers, apiserver and kubectl. Aside from being part of the Steering Committee, I’m also helping guide [SIG CLI](https://git.k8s.io/community/blob/master/sig-cli/README.md), [SIG Apps](https://git.k8s.io/community/blob/master/sig-apps/README.md) and [WG Batch](https://git.k8s.io/community/blob/master/wg-batch/README.md). 
