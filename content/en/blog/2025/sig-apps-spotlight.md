...
**[SIG Apps](https://git.k8s.io/community/tree/master/sig-apps#apps-special-interest-group)**,
...
[SIG CLI](https://git.k8s.io/community/tree/master/sig-cli#readme) and also being one of
...
As described in our
[charter](https://git.k8s.io/community/blob/master/sig-apps/charter.md#scope), we cover a
...
1. [The Batch Working Group](https://git.k8s.io/community/tree/master/wg-batch), which is
   looking at running HPC, AI/ML, and data analytics jobs on top of Kubernetes.
2. [The Serving Working Group](https://git.k8s.io/community/tree/master/wg-serving), which
...
bi-weekly [meetings](https://git.k8s.io/community/tree/master/sig-apps#meetings). As long
...
README](https://git.k8s.io/community/tree/master/sig-apps) and join their bi-weekly [meetings](https://git.k8s.io/community/tree/master/sig-apps#meetings).
