...
our attention to [SIG Testing](https://git.k8s.io/community/tree/master/sig-testing#readme),
...
Testing subprojects, check out the [SIG Testing README](https://git.k8s.io/community/tree/master/sig-testing#subprojects).*
...
**Patrick:** [test flakes](https://git.k8s.io/community/blob/master/contributors/devel/sig-testing/flaky-tests.md)…
...
one of their regular [bi-weekly meetings on Tuesdays](https://git.k8s.io/community/tree/master/sig-testing#meetings). If
