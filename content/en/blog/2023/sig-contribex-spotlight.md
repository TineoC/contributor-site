...
Experience](https://git.k8s.io/community/blob/master/sig-contributor-experience/README.md)
...
README](https://git.k8s.io/community/tree/master#readme) on
...
README](https://git.k8s.io/community/blob/master/sig-contributor-experience/README.md#subprojects)).
...
* [GitHub](https://git.k8s.io/community/tree/master/sig-contributor-experience#contributor-experience-special-interest-group)
* [Mailing list](https://groups.google.com/g/kubernetes-sig-contribex)
* [Open Community
  Issues/PRs](https://git.k8s.io/community/labels/sig%2Fcontributor-experience)
