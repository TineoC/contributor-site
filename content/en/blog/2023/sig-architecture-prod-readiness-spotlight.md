...
subproject](https://git.k8s.io/community/blob/master/sig-architecture/README.md#production-readiness-1)_.
...
with 5000 nodes. I’m still involved in [SIG Scalability](https://git.k8s.io/community/blob/master/sig-scalability/README.md)
...
**FSM**: On the topic of reaction, that made me think of how the [Kubernetes Enhancement Proposal (KEP)](https://git.k8s.io/enhancements/blob/master/keps/NNNN-kep-template/README.md)
...
**WT**: The [PRR process](https://git.k8s.io/community/blob/master/sig-architecture/production-readiness.md)
