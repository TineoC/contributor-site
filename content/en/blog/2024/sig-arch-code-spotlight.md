...
subprojects. We will cover [SIG Architecture: Code Organization](https://git.k8s.io/community/blob/e44c2c9d0d3023e7111d8b01ac93d54c8624ee91/sig-architecture/README.md#code-organization)._
...
Go](https://git.k8s.io/enhancements/tree/cf6ee34e37f00d838872d368ec66d7a0b40ee4e6/keps/sig-release/3744-stay-on-supported-go-versions),
...
[`client-go`](https://git.k8s.io/client-go).However, we as a project would also like the
...
of staging directories. In the [`kubernetes/kubernetes`](https://git.k8s.io/kubernetes)
repository, you will come across a directory called
[`staging/`](https://git.k8s.io/kubernetes/tree/master/staging). The sub-folders in this
directory serve as a bunch of pseudo-repositories. For example, the
[`kubernetes/client-go`](https://git.k8s.io/client-go) repository that publishes releases
for `client-go` is actually a [staging
repo](https://git.k8s.io/kubernetes/tree/master/staging/src/k8s.io/client-go).
...
there, we have a bot called the [`publishing-bot`](https://git.k8s.io/publishing-bot)
...
documentation](https://git.k8s.io/community/blob/master/contributors/devel/sig-architecture/staging.md).
...
team](https://git.k8s.io/org/blob/a106af09b8c345c301d072bfb7106b309c0ad8e9/config/kubernetes/org.yaml#L1329)
that helps review and approve dependency changes. These are folks who have helped lay the foundation
of much of the
[tooling](https://git.k8s.io/community/blob/master/contributors/devel/sig-architecture/vendor.md)
...
Go](https://git.k8s.io/enhancements/tree/cf6ee34e37f00d838872d368ec66d7a0b40ee4e6/keps/sig-release/3744-stay-on-supported-go-versions). The
...
be found [here](https://git.k8s.io/release/issues/3076).
...
[backporting](https://git.k8s.io/community/blob/master/contributors/devel/sig-release/cherry-picks.md)
...
hours](https://git.k8s.io/community/tree/master/sig-architecture#meetings) that takes
