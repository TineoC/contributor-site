...
Cloud Provider](https://git.k8s.io/community/blob/master/sig-cloud-provider/README.md).
...
[README](https://git.k8s.io/community/blob/master/sig-cloud-provider/README.md), I
...
framework](https://git.k8s.io/community/blob/master/sig-cloud-provider/README.md#kubernetes-cloud-provider)
and the [extraction/migration
project](https://git.k8s.io/community/blob/master/sig-cloud-provider/README.md#cloud-provider-extraction-migration). The
...
[KEP](https://git.k8s.io/enhancements/blob/master/keps/README.md) to a beta status and
...
(https://git.k8s.io/community/blob/master/sig-contributor-experience/README.md):
...
[here](https://git.k8s.io/community/blob/master/sig-cloud-provider/README.md#meetings).
