...
*Standa Láznička, [@stlaz](https://github.com/stlaz)*  
Significant contributions to Kubernetes image pull security.

*Harshal Neelkamal, [@HarshalNeelkamal](https://github.com/HarshalNeelkamal)*  
Significant contributions to Kubernetes external service account token signing.

#### Autoscaling

*Adrian Moisey, [@adrianmoisey](https://github.com/adrianmoisey)*  
Outstanding project maintainer (VPA) and Kubernaut omnivore.

*Omer Aplatony, [@omerap12](https://github.com/omerap12)*  
...
*Joshua James*  
Joshua documented the process for updating etcd versions in Kubernetes and has been working toward unifying how etcd images are managed in the project. He also takes on important release and dependency-update tasks, helping keep the etcd integration healthy and sustainable.
...
*Drew Sirenko*  
Drew has been a key contributor to the VolumeAttributesClass feature, driving its development and refinement through comprehensive end-to-end tests and careful bug fixes. His work has significantly increased the feature’s stability. He has also supported Kubernetes CSI sidecar releases and resolved bugs that improve the reliability of Kubernetes Storage overall.
